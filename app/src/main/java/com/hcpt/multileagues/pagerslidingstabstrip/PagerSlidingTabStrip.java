...
package com.hcpt.multileagues.pagerslidingstabstrip;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int underlineColor = getResources().getColor(
			R.color.tranparent);
	private int dividerColor = getResources().getColor(R.color.tranparent);
	...
	private int tabTextSize = (int) (getResources().getDimension(R.dimen.text_size_small) / getResources().getDisplayMetrics().density);
	private int tabTextColor = getResources().getColor(R.color.tab_textColor);
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		tabBackgroundResId = a.getResourceId(
				...
				tabBackgroundResId);
		// Set the 'true' to expand tabs full width
		// shouldExpand = a
	...
	private void addTextTab(final int position, String title) {
		...
		// getResources().getDrawable(R.drawable.ic_bird),
		// getResources().getDrawable(R.drawable.ic_place),
		// getResources().getDrawable(R.drawable.ic_share),
		// getResources().getDrawable(R.drawable.ic_map),
		// getResources().getDrawable(R.drawable.ic_photographer),
		// getResources().getDrawable(R.drawable.ic_sponsor),
		// getResources().getDrawable(R.drawable.ic_about) };
		...
		// Set icon
		// if (position == 0) {
		// tab.setCompoundDrawablesWithIntrinsicBounds(null, drawTabs[0],
		// null, null);
		// } else if (position == 1) {
		// tab.setCompoundDrawablesWithIntrinsicBounds(null, drawTabs[1],
		// null, null);
		// } else if (position == 2) {
		// tab.setCompoundDrawablesWithIntrinsicBounds(null, drawTabs[2],
		// null, null);
		// } else if (position == 3) {
		// tab.setCompoundDrawablesWithIntrinsicBounds(null, drawTabs[3],
		// null, null);
		// } else if (position == 4) {
		// tab.setCompoundDrawablesWithIntrinsicBounds(null, drawTabs[4],
		// null, null);
		// } else if (position == 5) {
		// tab.setCompoundDrawablesWithIntrinsicBounds(null, drawTabs[5],
		// null, null);
		// } else if (position == 6) {
		// tab.setCompoundDrawablesWithIntrinsicBounds(null, drawTabs[6],
		// null, null);
		// } else if (position == 7) {
		// tab.setCompoundDrawablesWithIntrinsicBounds(null, drawTabs[7],
		// null, null);
		// }
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				//Log.e("DEBUG",String.valueOf(tabTextSize));
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			/*if (pager.getOffscreenPageLimit() < tabCount) {
