...
public class AdapterSpentPoints extends RecyclerView.Adapter<AdapterSpentPoints.ViewHolder> {
    private Context context;
    private ArrayList<String> stringArrayList;


    public AdapterSpentPoints(Context context, ArrayList<String> stringArrayList) {
