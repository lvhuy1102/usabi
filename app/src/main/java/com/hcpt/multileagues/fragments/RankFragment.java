...
public class RankFragment extends Fragment {
    ...
    private View view;
    private RecyclerView mLvRankClubs;
    //    private RankClubsAdapter mRankClubAdapter;
    private TextView mLblNoData;
    private RankClubAdapterNew rankClubAdapterNew;
    ...
    private void initView() {
        mLvRankClubs = (RecyclerView) view.findViewById(R.id.lv_rank_clubs);
        ...
        mLvRankClubs.setLayoutManager(layoutManager);
        rankClubAdapterNew = new RankClubAdapterNew(getActivity(), GlobalValue.arrRankClubs);
        mLvRankClubs.setAdapter(rankClubAdapterNew);
...
//    }
    ...
    private void getRankFromDB() {
        com.hcpt.multileagues.utilities.Debug.e(GlobalValue.leagueId);
        ...
        if (apiInfos != null) {
            ...
            if (arrTemp != null && arrTemp.size() > 0) {
                ...
                rankClubAdapterNew.notifyDataSetChanged();
