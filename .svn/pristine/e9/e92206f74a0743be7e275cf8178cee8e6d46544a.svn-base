...
public class RankGroupAdapter extends RecyclerView.Adapter<RankGroupAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rank_group, parent, false);
...
//                        mActivity.startActivity(new Intent(mActivity, ClubDetailActivity.class));
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            llRank = (LinearLayout) view.findViewById(R.id.ll_rank_club);
            lblRank = (TextView) view.findViewById(R.id.lbl_rank_clubs);
//            imgLogo = (ImageView) view.findViewById(R.id.img_logoClub);
            lblNameClubs = (TextView) view.findViewById(R.id.lbl_name_clubs);
            lblNameClubs.setSelected(true);
            lblP = (TextView) view.findViewById(R.id.lbl_value_p);
            lblW = (TextView) view.findViewById(R.id.lbl_value_w);
            lblD = (TextView) view.findViewById(R.id.lbl_value_d);
            lblL = (TextView) view.findViewById(R.id.lbl_value_l);
            lblGD = (TextView) view.findViewById(R.id.lbl_value_gd);
            lblPTS = (TextView) view.findViewById(R.id.lbl_value_pts);
        }
    }
}
